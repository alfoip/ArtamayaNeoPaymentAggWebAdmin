...
/**
 * Generated from protobuf message <code>WebUser.GRPCDeleteWebUserRequest</code>
 */
class GRPCDeleteWebUserRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    protected $email = '';
    /**
     * Generated from protobuf field <code>string credentialpassword = 7;</code>
     */
    protected $credentialpassword = '';
     ...
     *     @type string $email
     *     @type string $credentialpassword
     * }
     */
     ...
     * @return $this
     */
    public function setCredentialpassword($var)
    {
        GPBUtil::checkString($var, True);
        $this->credentialpassword = $var;
