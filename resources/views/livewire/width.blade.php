...
@section('content')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Utilities</h4><span class="text-muted mt-1 tx-13 ml-2 mb-0">/ Width</span>
						</div>
					</div>
					...
					<div class="col-md-12 col-xl-12 col-xs-12 col-sm-12">
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="d-flex">
									<div class="d-flex align-items-center justify-content-center wd-80 ht-80 bg-gray-400">
										.wd-80
									</div>
