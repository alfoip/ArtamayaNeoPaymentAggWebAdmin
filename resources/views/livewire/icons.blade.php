...
@section('content')
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="my-auto">
							<div class="d-flex">
								<h4 class="content-title mb-0 my-auto">Icons</h4><span class="text-muted mt-1 tx-13 ml-2 mb-0">/ Icons</span>
							</div>
						</div>
							...
							<div class="card custom-card">
								<div class="card-body">
									<div>
										...
										<p class="text-muted mb-2 card-sub-title">Simply beautiful open source icons.<span class="text-dark">See more material design icons at <a href="http://materialdesignicons.com/" target="_blank"> Material Design Icons</a></span></p>
							...
							<div class="card custom-card">
								<div class="card-body">
									<div>
										...
										<p class="text-muted mb-2 card-sub-title">Simply beautiful open source icons.<span class="text-dark">See more Themify icons at <a href="https://themify.me/themify-icons" target="_blank"> Themify Icons</a></span></p>
							...
							<div class="card custom-card">
								<div class="card-body">
									<div>
										...
										<p class="text-muted mb-2 card-sub-title">Simply beautiful open source icons.</p>
