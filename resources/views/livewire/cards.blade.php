...
@section('content')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex"><h4 class="content-title mb-0 my-auto">Apps</h4><span class="text-muted mt-1 tx-13 ml-2 mb-0">/ Cards</span></div>
					</div>
				...
				<div class="row row-sm">
					<div class="col-md">
						<div class="card card-body bg-gray-400 bd-0">
