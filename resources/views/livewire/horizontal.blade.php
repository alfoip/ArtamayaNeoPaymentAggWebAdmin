									...
									<li>
										<div class="crypto-card">
										   <div class="row">
												<div class=" d-flex">
													<div class="">
														<img src="{{URL::asset('assets/img/crypto-currencies/round-outline/NEM.svg')}}" class="w-6 h-6 mt-0" alt="">
													</div>
													<div class="ml-3">
														<p class="mb-1 tx-13">ETH / USDT</p>
									...
									<li>
										<div class="crypto-card">
										   <div class="row">
												<div class=" d-flex">
													<div class="">
														<img src="{{URL::asset('assets/img/crypto-currencies/round-outline/Netko-coin.svg')}}" class="w-6 h-6 mt-0" alt="">
													</div>
													<div class="ml-3">
							...
							<div class="card-body p-0">
								<div class="">
									<div class="list d-flex align-items-center border-bottom p-2 pl-3 pr-3 mt-0">
										<img class="w-6 h-6" src="{{URL::asset('assets/img/crypto-currencies/round-outline/Bitcoin.svg')}}  " alt="image">
									...
									<div class="list d-flex align-items-center border-bottom p-2 pl-3 pr-3">
										<img class="w-6 h-6" src="{{URL::asset('assets/img/crypto-currencies/round-outline/Ethereum.svg')}}" alt="image">
										<div class="w-100 ml-3">
											<div class="d-flex justify-content-between align-items-center">
									...
									<div class="list d-flex align-items-center border-bottom p-2 pl-3 pr-3">
										<img class="w-6 h-6" src="{{URL::asset('assets/img/crypto-currencies/round-outline/Litecoin.svg')}}" alt="image">
										<div class="w-100 ml-3">
											<div class="d-flex justify-content-between align-items-center">
									...
									<div class="list d-flex align-items-center border-bottom p-2 pl-3 pr-3">
										<img class="w-6 h-6" src="{{URL::asset('assets/img/crypto-currencies/round-outline/Dash.svg')}}" alt="image">
										<div class="w-100 ml-3">
											<div class="d-flex justify-content-between align-items-center">
									...
									<div class="list d-flex align-items-center p-2 pl-3 pr-3 mb-0">
										<img class="w-6 h-6" src="{{URL::asset('assets/img/crypto-currencies/round-outline/NEM.svg')}}" alt="image">
										<div class=" w-100 ml-3">
											<div class="d-flex justify-content-between align-items-center">
												<p class="mt-1 mb-0 font-weight-semibold">BTC/USD</p>
						...
						<div class="card overflow-hidden recent-operations-card">
							<div class="card-body p-0">
								<div class="p-3 pb-0">
									...
									<p class="tx-12 tx-gray-500 mb-0">Transaction History shows information about cash deposits, cash withdrawals for your account.<a href="">Learn more</a></p>
								</div>
						...
						<div class="card overflow-hidden">
							<div class="card-body">
								<div class="">
									...
									<p class="tx-12 tx-gray-500 mb-2">A cryptocurrency is a new form of digital asset based on a network that is distributed across a large number of computers. This decentralized structure allows them to exist outside the control of governments and central authorities.<a href="">Learn more</a></p>
								</div>
