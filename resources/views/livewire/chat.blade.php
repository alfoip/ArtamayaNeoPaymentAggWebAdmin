...
@section('content')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex"><h4 class="content-title mb-0 my-auto">Mail</h4><span class="text-muted mt-1 tx-13 ml-2 mb-0">/ Chat</span></div>
					</div>
							...
							<div class="main-content-left main-content-left-chat">
								...
								<div class="main-chat-contacts-wrapper">
									...
									<div class="main-chat-contacts" id="chatActiveContacts">
										...
										<div>
											<div class="main-img-user online"><img alt="" src="{{URL::asset('assets/img/faces/5.jpg')}}"></div><small>George</small>
										</div>
										<div>
								...
								<div class="main-chat-list" id="ChatList">
									...
									<div class="media new">
										<div class="main-img-user">
											<img alt="" src="{{URL::asset('assets/img/faces/5.jpg')}}"> <span>1</span>
										</div>
										<div class="media-body">
											<div class="media-contact-name">
							...
							<div class="main-content-body main-content-body-chat">
								...
								<div class="main-chat-body" id="ChatBody">
									<div class="content-inner">
										...
										<div class="media">
											<div class="main-img-user online"><img alt="" src="{{URL::asset('assets/img/faces/5.jpg')}}"></div>
											<div class="media-body">
												<div class="main-msg-wrapper">
