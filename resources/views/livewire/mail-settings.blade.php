...
@section('content')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex"><h4 class="content-title mb-0 my-auto">Mail</h4><span class="text-muted mt-1 tx-13 ml-2 mb-0">/ Mail-setting</span></div>
					</div>
					...
					<div class="col-lg-8 col-xl-9">
						<div class="card">
							...
							<div class="card-footer">
								<div class="float-right"><a href="#" class="btn btn-success">Save Changes</a></div>
							</div>
						</div>
					</div>
					<!-- /Col -->
