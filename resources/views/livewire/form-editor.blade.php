...
@section('content')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Forms</h4><span class="text-muted mt-1 tx-13 ml-2 mb-0">/ Form-Editor</span>
						</div>
					</div>
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="wd-xl-100p ht-350">
									<div class="ql-scrolling-demo bg-gray-200" id="scrolling-container">
										<div id="quillInline">
